...
<script type="text/javascript">
	...
	{	
		...
		CargaFiltro("cboTrim",'Filtros.asp?rep=periodo_SupAnio&sup=S&anio='+Anio+'&eeff=04','cargaLetra');
	}
...
<form action="CambioPatNeto.asp" name="fmrEF" method="post" target=_self>
	...
	<a class="a2">&nbsp;&nbsp;</a>
	<button onClick="cargaVariablePN('S'); return false;" style="border:none;height:21px; width:21px;background: url(imagenes/search.png) no-repeat;" alt="Buscar Consulta"></button>
<br>
