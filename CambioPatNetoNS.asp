...
<strong>
<br>
<font face="Arial" size='3pt' color='#FFFFFF'>Cambio de Patrimonio Neto</font></strong>
<form action="CambioPatNeto.asp" name="fmrEF" method="post" target=_self>
	...
	<a class="a2">&nbsp;&nbsp;</a>
	<button onClick="cargaVariablePN('NS'); return false;" style="border:none;height:21px; width:21px;background: url(imagenes/search.png) no-repeat;" alt="Buscar Consulta"></button>
<br>
