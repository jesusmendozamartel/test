...
<strong>
<br>
<font face="Arial" size='3pt' color='#FFFFFF'>Consolidado EEFF</font></strong>
<form action="ConsolidadoEEFFFondos.asp" name="fmrEF" method="post" target=_self>

 	<a class="a2">&nbsp;&nbsp;Periodo</a>
 	<select name="cboAnio" id="cboAnio" class="combo2" onchange="CargarPeriodo();"></select>
	<select name="cboTrim" id="cboTrim" class="combo2"></select>
	...
	<select name="cboFondo" id="cboFondo" class="combo2">
		...
		<option value='PAT'>Patrimonio en fideicomiso</option>
	</select>

	<a id="detalle" class=a2>&nbsp;&nbsp;Vista</a>
		<select name="cboVista" id="cboVista" class="combo2" onchange="">
			<option value='1'>Horizontal</option>
			<option value='2'>Vertical</option>
		</select>

	<a class="a2">&nbsp;&nbsp;</a>
	<button onClick="cargaConsolidadoEEFF_FONDOS(); return false;" style="border:none;height:21px; width:21px;background: url(imagenes/search.png) no-repeat;" alt="Buscar Consulta"></button>
	<button onClick="ExcelConsolidadoEEFF_FONDOS(); return false;" style="border:none;height:21px; width:21px;background: url(imagenes/excel.png) no-repeat;" alt="Exportar a Excel"></button>
