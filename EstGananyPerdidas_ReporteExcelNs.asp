...
Response.Charset= "ISO-8859-1" 
	...
	SQL=" exec sp_lista_cuentas_RepAnioTrimLetSup '02','"&annio&"','"&trime&"','"&letra&"','"&metodo&"','NS'"
	...
	Archivo="GananciasYPerdidas"
	Titulo="GANANCIAS Y PERDIDAS SMV, " &annio&" - "&trime&"<br>"&NivText&": "&codText&" (Categoria "&letText&" / "&detText&")<br> Miles de "&monedaText
	...
	if detalle =0 then		
		response.write("<tr><td colspan='2' rowspan='7' align='center' bgcolor='#E4F2FC'><strong><font size='2pt'>Ganancias y Pérdidas</font></strong></td><td bgcolor='#E4F2FC' align='right'>Codigo Empresa</td></tr>")
	...
	SQL="EXEC sp_lista_directorio_RepAnioTriNivMonLetMetSup '02','"&annio&"','"&trime&"','"&nivel&"','"&codigo&"','"&moneda&"','"&letra&"','DIRECTO','NS','"&detalle&"'"
	SQL2=" exec sp_lista_reporteDatos_RepAnioTrimNilMonLetMetSup '02','"&annio&"','"&trime&"','"&nivel&"','"&codigo&"','"&moneda&"','"&letra&"','DIRECTO','NS','"&detalle&"'"
	...
	for j=0 to X1
		...
		for i=0 to Y1
			...
			if i Mod 2 = 0 then				
				response.write("<td colspan='2' align='center' bgcolor='#FFE7BB' "&format&">"&dato&"</td>")
			else
				response.write("<td colspan='2' align='center' bgcolor='#E3EEF7' "&format&">"&dato&"</td>")
			end if
