...
'response.End()
	...
	if detalle =0 then		
		response.write("<tr><td colspan='2' rowspan='7' align='center' bgcolor='#E4F2FC'><strong><font size='2pt'>Ganancias y Pérdidas No Supervisadas</font></strong></td><td bgcolor='#E4F2FC' align='right'>Codigo Empresa</td></tr>")
	...
	for j=0 to X1
		...
		for i=0 to Y1
			...
			if i Mod 2 = 0 then
				response.write("<td colspan='2' align='center' bgcolor='#FFE7BB'>"&dato&"</td>")
				
			else
				response.write("<td colspan='2' align='center' bgcolor='#E3EEF7'>"&dato&"</td>")
