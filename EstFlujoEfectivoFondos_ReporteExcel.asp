...
Response.Charset= "ISO-8859-1" 
	...
	'Método sólo servirá para Flujo Efectivo	
	
	SQL=" exec sp_lista_cuentas_RepAnioTrim_FONDOS '03','"&annio&"','"&trime&"',"&metodo&",'"&detalle&"','"&TipFondo&"'"
	...
	Archivo="FlujoEfectivoFondos_"&FondoText
	Titulo="FLUJO EFECTIVO SMV, "&FondoText&" " &annio&" - "&trime&" Método " & metodo & "<br><br> Miles de "&monedaText
	...
	if detalle =0 then	
		response.write("<tr><td colspan='2' rowspan='5' align='center' bgcolor='#E4F2FC'><strong><font size='2pt'>Flujo de Efectivo Fondos</font></strong></td><td bgcolor='#E4F2FC' align='right'>Codigo Sociedad Administradora</td></tr>")
	...
	SQL="EXEC sp_lista_directorio_RepAnioTriMonMet_FONDOS '03','"&annio&"','"&trime&"','"&moneda&"',"&metodo&","&detalle&",'"&TipFondo&"'"
	SQL2=" exec sp_lista_reporteDatos_RepAnioTrimMonMet_FONDOS '03','"&annio&"','"&trime&"','"&moneda&"',"&metodo&","&detalle&",'"&TipFondo&"'"
