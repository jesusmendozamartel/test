...
<script type="text/javascript">
	...
	function cargaCodigos(){
		...
		var c = document.getElementById("cboMetodo");
		c.innerHTML = "";
		if(letra=='I'){
			var option = document.createElement("option");
			option.text = "AB";			
			...
			option2.text = "Indirecto";			
			option2.value = "Indirecto";
			c.add(option2);
		}
	}
...
<strong>
<br>
<font face="Arial" size='3pt' color='#FFFFFF'>Estado Flujo Efectivo No Supervisadas</font></strong>
<form action="EstFlujoEfectivoNS.asp" name="fmrEF" method="post" target=_self>
	...
	<a class="a2">&nbsp;&nbsp;</a>
	<button onClick="cargaVariableEF('FE','NS'); return false;" style="border:none;height:21px; width:21px;background: url(imagenes/search.png) no-repeat;" alt="Buscar Consulta"></button>
	<button onClick="ExcelEF('FE','NS'); return false;" style="border:none;height:21px; width:21px;background: url(imagenes/excel.png) no-repeat;" alt="Exportar a Excel"></button>
<br>
