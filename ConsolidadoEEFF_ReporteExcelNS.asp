...
Response.Charset= "ISO-8859-1" 
	...
	Archivo="ConsolidadoEEFF_NS"
	Titulo="CONSOLIDADO DE ESTADOS FINANCIEROS SMV (Empresas No Supervisadas), " &annio&" - "&trime&"<br>"&NivText&": "&codText&" (Categoria "&letText&" / "&detText&")<br> Miles de "&monedaText
	...
	while not rs02.eof
		response.write("<tr><td align='left'>"&rs02(2)&"</td><td align='center'>"&rs02(0)&"</td><td align='left'>"&rs02(3)&"</td></tr>")
    	rs02.MoveNext
	wend
	rs02.Close
	Set rs02=Nothing
	...
	while not rs03.eof
		response.write("<tr><td align='left'>"&rs03(2)&"</td><td align='center'>"&rs03(0)&"</td><td align='left'>"&rs03(3)&"</td></tr>")
    	rs03.MoveNext
	wend
	rs03.Close
	Set rs03=Nothing
