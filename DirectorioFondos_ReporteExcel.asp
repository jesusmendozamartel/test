...
<%
	...
	xtipfondos=Request.QueryString("xtipfondos") 
	annio=Request.QueryString("annio")
	trime=Request.QueryString("trime")
	
	SQL="exec sp_lista_directorioFONDOS_x_anioTipFondo '"&annio& "','"&trime& "','"&xtipfondos& "'"

	Archivo="DirectorioFondos"
	Titulo="Directorio de Fondos "
