...
<div align="center">
  ...
  <br />
  <strong><font face="Arial" size='3pt' color='FFFFFF'>Directorio de Empresas no Supervisadas</font></strong></div>
<form action="DirectorioNS.asp" name="fmrEF" method="post" target=_self>
...
%>
  ...
  <div name="formulario" id="formulario1">
	...
	<select name="cboTrim" id="cboTrim" class="combo2">
	  ...
	  <a class="a2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ordenar Por: </a>
	  <select name="cboOrden" id="cboOrden" class="combo2" >
        <option value="" selected>
        <%Response.Write "[Seleccione]"%>
        </option>
        <option value="1"<%If Trim(CStr(strUbicaOrden)) = "1" Then%>selected<% End If%>>Id_Emp</option>
        <option value="2"<%If Trim(CStr(strUbicaOrden)) = "2" Then%>selected<% End If%>>Razon Social</option>
        <option value="3"<%If Trim(CStr(strUbicaOrden)) = "3" Then%>selected<% End If%>>Ciiu</option>
      </select>
	...
	<input type="hidden" name="cboOrden" id="cboOrden" value="0">
		...
		&nbsp;&nbsp;
		<button onClick="cargaVariableNS(1,'DI');return false;" style=" border:none; height:21px; width:21Px;font-weight:bold;font-size:8pt;background-color:#ffffff;color:#123456;">
			<img  src="Imagenes/search.png" width="20" height="20" alt="Buscar Consulta" >
		</button>&nbsp;&nbsp;
		<button onClick="ExcelNS(1,'DI');return false;" style=" border:none; height:21px; width:21Px;font-weight:bold;font-size:8pt;background-color:#ffffff;color:#123456;">
			<img  src="imagenes/excel.png" width="20" height="20" alt="Exportar a Excel" >
		</button>&nbsp;&nbsp;
		<button onClick="Refresh(7)" style=" border:none; height:21px; width:21Px;font-weight:bold;font-size:8pt;background-color:#ffffff;color:#123456;">
