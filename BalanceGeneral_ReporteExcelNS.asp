...
Response.Charset= "ISO-8859-1" 
	...
	SQL=" exec sp_lista_cuentas_RepAnioTrimLetSup '01','"&annio&"','"&trime&"','"&letra&"','"&metodo&"','NS'"
	...
	Archivo="BalanceGeneralNS"
	Titulo="BALANCE GENERAL NO SUPERVISADAS SMV, " &annio&" - "&trime&"<br>"&NivText&": "&codText&" (Categoria "&letText&" / "&detText&")<br> Miles de "&monedaText
	...
	if detalle =0 then		
		response.write("<tr><td colspan='2' rowspan='7' align='center' bgcolor='#E4F2FC'><strong><font size='2pt'>Balance General No Supervisadas</font></strong></td><td bgcolor='#E4F2FC' align='right'>Codigo Empresa</td></tr>")
	...
	SQL="EXEC sp_lista_directorio_RepAnioTriNivMonLetMetSup '01','"&annio&"','"&trime&"','"&nivel&"','"&codigo&"','"&moneda&"','"&letra&"','DIRECTO','NS','"&detalle&"'"
	SQL2=" exec sp_lista_reporteDatos_RepAnioTrimNilMonLetMetSup '01','"&annio&"','"&trime&"','"&nivel&"','"&codigo&"','"&moneda&"','"&letra&"','DIRECTO','NS','"&detalle&"'"
