...
Response.Charset= "ISO-8859-1" 
	...
	SQL=" exec sp_lista_cuentas_RepAnioTrimLetSup '02','"&annio&"','"&trime&"','"&letra&"','"&metodo&"','S'"
	...
	SQL="EXEC sp_lista_directorio_RepAnioTriNivMonLetMetSup '02','"&annio&"','"&trime&"','"&nivel&"','"&codigo&"','"&moneda&"','"&letra&"','DIRECTO','S','"&detalle&"'"
	SQL2=" exec sp_lista_reporteDatos_RepAnioTrimNilMonLetMetSup '02','"&annio&"','"&trime&"','"&nivel&"','"&codigo&"','"&moneda&"','"&letra&"','DIRECTO','S','"&detalle&"'"
