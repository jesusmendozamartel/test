...
<script type="text/javascript">
	...
	function cargaLetra(){
		...
		CargaFiltro("cboLetra",'Filtros.asp?rep=letra_SupAnioPer&sup=NS&anio='+Anio+'&per='+Periodo+'&eeff=04','cargaCodigos');
	}
	...
	function cargaCodigos(){
		...
		if(nivel==0){
			...
			CargaFiltro("cboCodigo",'Filtros.asp?rep=codigo_SupAnioPerLetrNiv&sup=NS&anio='+Anio+'&per='+Periodo+'&letr='+letra+'&niv='+nivel+'&eeff=04','');
		}
	}
...
<form action="Dividendos.asp" name="fmrEF" method="post" target=_self>
	...
	<a class="a2">&nbsp;&nbsp;</a>
	<button onClick="cargaDividendos('NS'); return false;" style="border:none;height:21px; width:21px;background: url(imagenes/search.png) no-repeat;" alt="Buscar Consulta"></button>
	<button onClick="ExcelDividendos('NS'); return false;" style="border:none;height:21px; width:21px;background: url(imagenes/excel.png) no-repeat;" alt="Exportar a Excel"></button>
<br>
