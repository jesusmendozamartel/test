...
Response.Charset= "ISO-8859-1" 
	...
	SQL01=" exec sp_lista_cuentas_reporte_x_RepAnioTrime '01','"&annio&"','"&trime&"','"&letra&"','NS'"
	SQL02=" exec sp_lista_cuentas_reporte_x_RepAnioTrime '02','"&annio&"','"&trime&"','"&letra&"','NS'"
	SQL03=" exec sp_lista_cuentas_reporte_x_RepAnioTrime '03','"&annio&"','"&trime&"','"&letra&"','NS'"
	...
	Archivo="ConsolidadoEEFF"
	Titulo="CONSOLIDADO DE ESTADOS FINANCIEROS SMV, " &annio&" - "&trime&"<br>"&NivText&": "&codText&" (Categoria "&letText&" / "&detText&")<br> Miles de "&monedaText
	...
	if detalle =0 then
		response.write("<tr><td colspan='3' rowspan='4' align='center' bgcolor='#E4F2FC'><strong><font size='2pt'>Consolidado EEFF</font></strong></td><td bgcolor='#E4F2FC' align='right'>Ruc</td></tr>")
	...
	elseif detalle =1 then
		response.write("<tr><td colspan='3' align='center' bgcolor='#E4F2FC'><strong><font size='1pt'>Consolidado EEFF</font></strong></td><td bgcolor='#E4F2FC' align='right'>"&NivText&"</td></tr>")
	end if

	response.write("<tr bgcolor='#94B9FD'><td>Cuenta</td><td>Tipo</td><td align='center'>NroOrden</td><td align='left'>Descripcion</td></tr>")

	'CUENTAS BALANCE GENERAL X
	response.write("<tr bgcolor='#F2DCDB'><td></td><td></td><td align='center'></td><td align='left'><strong>Balance General "&annio&"</strong></td></tr>")

	while not rs01.eof
		response.write("<tr><td>"&rs01(0)&"</td><td>"&rs01(1)&"</td><td align='center'>"&rs01(2)&"</td><td align='left'>"&rs01(3)&"</td></tr>")
    	rs01.MoveNext
	wend
	...
	rs01.MoveFirst
	response.write("<tr bgcolor='#F2DCDB'><td></td><td></td><td align='center'></td><td align='left'><strong>Balance General "&annio-1&"</strong></td></tr>")
	...
	rs01.MoveFirst
	response.write("<tr bgcolor='#F2DCDB'><td></td><td></td><td align='center'></td><td align='left'><strong>Balance General Flujo</strong></td></tr>")
	...
	rs02.MoveFirst
	response.write("<tr bgcolor='#F2DCDB'><td></td><td></td><td align='center'></td><td align='left'><strong>Estado de Resultados</strong></td></tr>")

	while not rs02.eof
		response.write("<tr><td>"&rs02(0)&"</td><td>"&rs02(1)&"</td><td align='center'>"&rs02(2)&"</td><td align='left'>"&rs02(3)&"</td></tr>")
    	rs02.MoveNext
	wend
	...
	SQL="EXEC sp_lista_directorioefConsolidado_x_anio '01','"&annio&"','"&trime&"','"&nivel&"','"&codigo&"','"&moneda&"','"&letra&"','NS','"&detalle&"'"	
	...
	SQL01=" exec sp_lista_reporteDatos_RepAnioTrimNilMonLetMetSup '01','"&annio&"','"&trime&"','"&nivel&"','"&codigo&"','"&moneda&"','"&letra&"','Directo','NS',"&detalle
	SQL02=" exec sp_lista_reporteDatos_RepAnioTrimNilMonLetMetSup '02','"&annio&"','"&trime&"','"&nivel&"','"&codigo&"','"&moneda&"','"&letra&"','Directo','NS',"&detalle
	SQL03=" exec sp_lista_reporteDatos_RepAnioTrimNilMonLetMetSup '03','"&annio&"','"&trime&"','"&nivel&"','"&codigo&"','"&moneda&"','"&letra&"','Directo','NS',"&detalle&",1"
