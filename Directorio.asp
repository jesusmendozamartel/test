...
%>
  ...
  <div name="formulario" id="formulario1">
	...
	<input type="hidden" name="cboOrden" id="cboOrden" value="0">
		...
		&nbsp;&nbsp;
		<button onClick="cargaVariable(1,'DI');return false;" style=" border:none; height:21px; width:21Px;font-weight:bold;font-size:8pt;background-color:#ffffff;color:#123456;">
			<img  src="Imagenes/search.png" width="20" height="20" alt="Buscar Consulta" >
		</button>&nbsp;&nbsp;
		<button onClick="Excel(1,'DI');return false;" style=" border:none; height:21px; width:21Px;font-weight:bold;font-size:8pt;background-color:#ffffff;color:#123456;">
